...
exports.parseOutputPath = exports.findOutputPaths = exports.interpolateWithGlobalContext = exports.getObjectValueForInterpolation = exports.getSelectedStatusCheckFromIfStatementTemplate = exports.interpolateWithOutputs = exports.interpolateWithInputs = exports.BUILD_STEP_IF_CONDITION_EXPRESSION_REGEXP = exports.BUILD_STEP_OR_BUILD_GLOBAL_CONTEXT_REFERENCE_REGEX = exports.BUILD_GLOBAL_CONTEXT_EXPRESSION_REGEXP = exports.BUILD_STEP_OUTPUT_EXPRESSION_REGEXP = exports.BUILD_STEP_INPUT_EXPRESSION_REGEXP = void 0;
...
exports.BUILD_STEP_IF_CONDITION_EXPRESSION_REGEXP = /\${\s*(always|success|failure|never)\(\)\s*}/;
 ...
 */
function getSelectedStatusCheckFromIfStatementTemplate(ifCondition) {
    const matched = ifCondition.match(new RegExp(exports.BUILD_STEP_IF_CONDITION_EXPRESSION_REGEXP, 'g'));
    if (!matched) {
        // this should never happen because of regex pattern validation
        throw new errors_js_1.BuildConfigError(`Invalid if condition template.`);
    }
    const [, selectedStatusCheck] = (0, nullthrows_js_1.nullthrows)(matched[0].match(exports.BUILD_STEP_IF_CONDITION_EXPRESSION_REGEXP));
    return selectedStatusCheck;
}
exports.getSelectedStatusCheckFromIfStatementTemplate = getSelectedStatusCheckFromIfStatementTemplate;
