 ...
 */
export function getSelectedStatusCheckFromIfStatementTemplate(ifCondition) {
    ...
    const [, selectedStatusCheck] = nullthrows(matched[0].match(BUILD_STEP_IF_CONDITION_EXPRESSION_REGEXP));
